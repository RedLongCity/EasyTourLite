 ...
 */
@Service
public class SearchParamsExtractor implements Extractor, ItToursUrls {

    private static final Logger LOG = Logger.getLogger(SearchParamsExtractor.class.getName());
    ...
    public void extract(HttpUtils.GetCallBack callBack) {
        try {
            ...
            Logger.getLogger(SearchParamsExtractor.class.getName()).log(Level.SEVERE, null, ex);
